...
def handle_streaming_response(text, current_user):
    ...
    try:
        ...
        if is_simple_question(text):
            ...
            # Handle common simple questions with quick responses
            text_lower = text.lower().strip()
            
            if any(phrase in text_lower for phrase in ["who are you", "what are you"]):
                if current_user == "Daveydrz":
                    speak_streaming("I'm your AI assistant, Buddy! I'm here to help you with anything you need.")
                else:
                    display_name = get_voice_based_display_name(current_user)
                    speak_streaming(f"I'm Buddy, your AI assistant! Nice to meet you, {display_name}.")
                return
                
            elif any(phrase in text_lower for phrase in ["how are you"]):
                speak_streaming("I'm doing great! Thanks for asking. How can I help you today?")
                return
                
            elif any(phrase in text_lower for phrase in ["what's up", "how are things"]):
                speak_streaming("Everything's going well! What can I do for you?")
                return
